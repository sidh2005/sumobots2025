...
// ultrasonic_init
const int trigPins[3] = {51, 39, 31};  
const int echoPins[3] = {53, 41, 33};
const int numSensors = 3; 
const int detectionThreshold = 30; // cm

// motor_init
int motorSpeed = 255; // 0–255 //keep at !max! cause backEMF stuff 
...
void turnUntilCenterSeesOpponent(void (*turnFunc)()) {
  setMotorSpeed(180); // slow + controlled turn
